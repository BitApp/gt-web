  ...
  <div class="gt-body">
    ...
    <div class="gt-web-exchange clearfix">
      <div class="title-bar">
        ...
        <span class="prod-name">{{ prod ? prod.name : "" }}</span>
        <i>
        </i>
      </div>
      <div class="prod-content" v-if="prod">
        <div>
        ...
        <div class="text-panel">
          ...
          <div class="inventory">
            ...
            <span class="value">{{ prod.inventory }}</span>
          </div>
          <div class="sep"></div>
          <p class="desc">
            {{prod.desc}}
...
export default {
  ...
  mounted(){
    ...
    this.$common.getProduct(this.$route.params.id).then( res => {
      this.prod = res.data
    })
  },  
  methods:{
        ...
        if (window.IWalletJS) { 
          window.IWalletJS.enable().then((account) => {
            if(!account) {
              ...
              _this.$common.getTokenBalance(account, _this.prod.token).then( res =>{
